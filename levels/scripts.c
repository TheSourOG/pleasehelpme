...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_BLINKING_MUSHROOM,       blinking_mushroom_geo),
    LOAD_MODEL_FROM_GEO(MODEL_Z_MOVING_PLATFORM,       z_moving_platform_geo),
    LOAD_MODEL_FROM_GEO(MODEL_H_MOVING_PLATFORM,       h_moving_platform_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SPIKED_GOOMBA,           spiked_goomba_geo),
    LOAD_MODEL_FROM_GEO(MODEL_SQUISHY_FLESH_PLATFORM,  squishy_flesh_platform_geo),
